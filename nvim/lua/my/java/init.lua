...
local key_mappings = {
  ...
  {'n','<leader>iv',[[<cmd>lua require('jdtls').extract_variable()<cr>]]},
  {'v','<leader>iv',[[<esc><cmd>lua require('jdtls').extract_variable(true)<cr>]]},
  {'n','<leader>ic',[[<cmd>lua require('jdtls').extract_constant()<cr>]]},
  {'v','<leader>ic',[[<esc><cmd>lua require('jdtls').extract_constant(true)<cr>]]},
  {'v','<leader>im',[[<esc><cmd>lua require('jdtls').extract_method(true)<cr>]]},
}
...
function M.start_jdt()
  ...
  local config = {
    ...
    cmd = {
        '/home/sshimanski/.local/share/nvim/lspinstall/java/jdtls.sh',
        workspace_folder
    },
    root_dir = root_dir,
    settings = {
